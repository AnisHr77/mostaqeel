                ...
                <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-7xl">
                    ...
                    <div className="md:w-1/3 flex justify-center ">
                        <div className="rounded-xl overflow-hidden">
                            <img
                                ...
                                className="w-[300px] md:w-[800px] object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div className="w-1/3 text-center lg:text-right">
                        <h3 className="mb-2 flex flex-col text-white leading-tight gilroy-bold  font-bold  text-5xl md:text-6xl">
                            ...
                            <span className="flex gap-4 justify-center md:justify-center">
                                FPS
                               <svg className={'md:relative xl:relative  absolute z-10 left-17 xl:left-0  md:left-0  top-134 xl:top-4 md:top-4'} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2_22980)">
...
<rect width="48" height="48" fill="white"/>
                ...
                <p className="text-gray-400 md:w-100 lg:w-120 max-w-xl mt-10 mb-8 text-center gilroy-regular text-md leading-relaxed">
                   <span> Built for gamers who want smoother, faster gameplay.</span>
                    <br/>IQ Optimizer boosts FPS and fine-tunes your system,
                    no upgrades needed.
                </p>
